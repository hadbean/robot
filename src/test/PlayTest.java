...
主上:5,6,6,7,8,8,9,9,10,J,Q,K,K,K,A,2,JOKER2,	PASS
        ...
        String s = "地主:3,3,3,4,4,4,5,6,7,8,8,9,10,10,J,Q,K,A,2,JOKER1,\tPASS\n" +
                "主下:5,5,6,6,7,7,8,9,10,J,J,J,K,K,A,2,2,\tPASS\n" +
                "主上:3,4,5,6,7,8,9,9,10,Q,Q,Q,K,A,A,2,JOKER2,\tPASS";
        String[] ss = s.split("\n");
        if (ss.length == 3) {
